export const TAIWAN_COUNTIES: Record<string, string[]> = {
  ...
  "彰化縣": ["彰化市", "員林市", "鹿港鎮", "和美鎮", "北斗鎮", "溪湖鎮", "田中鎮", "二林鎮", "線西鄉", "伸港鄉", "芬園鄉", "秀水鄉", "花壇鄉", "福興鄉", "大村鄉", "埔心鄉", "埔鹽鄉", "永靖鄉", "芳苑鄉", "竹塘鄉", "溪州鄉", "社頭鄉", "二水鄉", "埤頭鄉", "田尾鄉", "大城鄉"],
  ...
  "臺東縣": ["臺東市", "成功鎮", "關山鎮", "卑南鄉", "鹿野鄉", "池上鄉", "延平鄉", "東河鄉", "長濱鄉", "太麻里鄉", "大武鄉", "綠島鄉", "海端鄉", "達仁鄉", "金峰鄉", "蘭嶼鄉"],
  "澎湖縣": ["馬公市", "湖西鄉", "白沙鄉", "西嶼鄉", "望安鄉", "七美鄉"],
  "金門縣": ["金城鎮", "金沙鎮", "金湖鎮", "金寧鄉", "烈嶼鄉", "烏坵鄉"],
  "連江縣": ["南竿鄉", "北竿鄉", "莒光鄉", "東引鄉"],
};

export const COUNTY_LIST = Object.keys(TAIWAN_COUNTIES);
